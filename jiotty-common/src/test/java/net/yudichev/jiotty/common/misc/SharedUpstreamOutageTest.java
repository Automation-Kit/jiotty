...
class SharedUpstreamOutageTest {
    ...
    static Stream<Arguments> failures() {
        return Stream.of(
                ...
                arguments(new HttpResponseException(502, "Bad Gateway"), true),
                // a throttle on the shared key/egress limits every caller at once
                arguments(new HttpResponseException(429, "Too Many Requests"), true),
                ...
                arguments(new CompletionException(new HttpResponseException(503, "Service Unavailable")), true),
                arguments(new RuntimeException(new IOException("connection reset")), true),
                // this caller's own request or data is at fault
                arguments(new HttpResponseException(401, "Unauthorized"), false),
