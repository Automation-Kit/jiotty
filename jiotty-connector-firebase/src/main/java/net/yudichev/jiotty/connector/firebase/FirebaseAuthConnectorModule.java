...
public final class FirebaseAuthConnectorModule extends BaseExposedKeyModule<FirebaseAuthConnector> {
    ...
    protected void configure() {
        ...
        httpTimeoutSpec.bind(Duration.class)
                       .annotatedWith(FirebaseAuthConnectorImpl.Dependency.class)
                       .installedBy(this::installLifecycleComponentModule);
        bind(exposedKey).to(registerLifecycleComponent(FirebaseAuthConnectorImpl.class));
        expose(exposedKey);
    }

    public static final class Builder extends BaseModuleBuilder<FirebaseAuthConnector, Builder> {
        ...
        public ExposedKeyModule<FirebaseAuthConnector> build() {
            return new FirebaseAuthConnectorModule(credentialsSpec, projectIdSpec, httpTimeoutSpec, specifiedAnnotation());
        }
    }
}
